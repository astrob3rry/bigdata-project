...
spark-submit --conf spark.pyspark.python=/share/apps/python/3.6.5/bin/python datamart.py metadata.json
'''
...
spark = SparkSession.builder.appName("datamart-test").config("spark.some.config.option", "some-value").getOrCreate()
spark.sparkContext.addPyFile("dataclasses.py")
spark.sparkContext.addPyFile("datamart_profiler.zip")
